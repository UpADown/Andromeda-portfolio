...
let container = document.querySelector(".article-data-container");
...
let hdButton = document.getElementById("submit");
hdButton.addEventListener("click", () => {
  getImage("hd");
});

function getImage(value) {
  let imageContainer = document.querySelector(".article-data-container");
